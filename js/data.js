  ...
  },
  {
    ...
    `,
      ...
      },
      {
        name: "학기 성적 문의",
        type: "YES",
        title: `[학점 문의] SUBJECT 과목 학점 문의 드립니다.`,
        content: [
          `다름이 아니라, 이번학기 SUBJECT 과목을 수강하는데 있어서 최선을 다했습니다.
      ...
      },
      {
        name: "평균/표준편차 문의",
        type: "YES",
        title: `[평균 문의] SUBJECT 과목 /*중간고사/기말고사*/ 평균 문의 드립니다.`,
        content: [
          `다름이 아니라, 이번 /*중간고사/기말고사*/에서 제가 어느정도에 위치해있는지 궁금해서 메일 드렸습니다.
            혹시 가능하시다면 평균과 표준편차, 중간값을 공지해주실 수 있나요?
            `,
        ],
      },
    ],
    ...
    details: [
      {
        name: "수업 내용 질문",
        type: "YES",
        title: "[수업 질문] SUBJECT 과목 수업 내용 질문 드립니다.",
        content: [
...
3. (4장 56쪽) 안테나 종류에는 isotropic, omnidirectional, directional antenna가 있고 이 안테나들을 사용하는 방식의 종류에 위성통신, 지상통신이 있는건가요? 즉, parabolic 안테나를 사용해 위성통신, 지상통신 모두 구현이 가능한가요? 그리고 omnidirectional 안테나로 지상통신 및 위성통신으로 wifi, cellular 통신을 지원하는 것인가요?
      ...
      },
      {
        name: "과제 내용 질문",
        type: "YES",
        title: `[과제 질문] SUBJECT 과목 /*00과제*/ 관련하여 질문 드립니다.`,
        content: [
...
과제 설명에 나와있는 꼭 필요한 것들만 넣었다고 생각했는데, appendices를 포함하면 1700단어 넘게 나와서 문의드립니다.
    `,
      ...
      },
      {
        name: "과제 늦제출",
        type: "YES",
        title: `[과제 늦제출] SUBJECT 과목 /*00과제*/ 제출에 대해서 문의 드립니다.`,
        content: [
          `다름이 아니라, /*사유가 있다면: “죄송하지만 00한 사정으로 인해*/ 부득이하게 과제를 제때 제출하지 못하여 혹시 지금 메일로 제출해도 되는지 문의드립니다. `,
        ],
      },
    ],
  },
    ...
    details: [
      {
        name: "병결",
        type: "YES",
        title: `[출결 문의] SUBJECT 과목 병결 처리 문의 드립니다.`,
        content: [
          `다름이 아니라, 제가 코로나 확진으로 인하여 /*00월 00일부터 00월 00일*/까지 자가격리를 하게 되었습니다.
            이 기간 사이의 수업을 온라인으로 참여하거나, 출석 인정처리를 받을 수 있을까요?
            코로나 확진 문자 사진 메일에 첨부합니다.
            `,
          `다름이 아니라, 제가 /*건강 악화로/00으로*/ 인해 병원에 입원을 하게 되었습니다. 
            이로 인해 /*00월 00일*/에 수업 참여가 어려울 것 같은데, 혹시 입원진단서를 제출한다면 출석 인정 처리를 받을 수 있을까요?
            `,
          `제가 /*00월 00일*/ 수업에 급격한 몸 상태의 악화로 응급실에 가게되어 수업에 참여하지 못했습니다.
      ...
      },
      {
        ...
        content: [
          `다름이 아니라, 학과에서 진행하는 /*00행사*/ 참여로 /*00월 00일*/ 수업에 참여하기 어려울 것 같습니다.
            학과 사무실에 문의한 결과, 참여확인서를 발급 받을 수 있다고 하는데요, 혹시 이를 제출하면 출석 인정이 가능한지 문의드리고자 합니다.
            `,
          `다름이 아니라, /*00월 00일*/에 저희 학과 필수 참여 행사가 있는 관계로, 수업에 참여하기 어려울 것 같습니다.
            학과 사무실에서 참석 확인서를 발급받았는데, 제출 시 출석 인정이 가능한지 문의드립니다.
            미리 말씀드리지 못한 점 죄송하다는 말씀 드리며, 확인해 주시면 제출하도록 하겠습니다.
            `,
          `다름이 아니라, /*00월 00일*/에 회사 면접으로 인하여 부득이하게 수업 참석이 어려울 것 같습니다.
            인사팀에 문의한 결과, 면접 날짜 조정이 어렵다는 답변을 받았습니다.
    ...
    details: [
      {
        ...
        content: [
          `다름이 아니라, 제가 이번 /*00기업/00대학/00재단*/에서 진행하는 /*00장학금*/을 받기위해, 교수님의 추천서가 필요하게되었습니다.
            /*
            (본인에 대한 소개, 장학금을 받아야 하는 이유, 교수님의 추천서가 필요한 이유 등의 내용)(관련 서류 파일을 첨부한 경우) 관련 서류는 메일에 첨부하였습니다.
            */
            `,
          `다름이 아니라, 제가 /*00대학원 00학과*/에 진학하기 위해, 교수님께 추천서를 부탁드리고자 메일을 드렸습니다.
            /*
            (본인에 대한 소개, 해당 대학원에 진학하고자 하는 이유, 교수님의 추천서가 필요한 이유 등의 내용)
            (관련 서류 파일을 첨부한 경우) 관련 서류는 메일에 첨부하였습니다.
            */
            `,
        ],
      },
      {
        ...
        content: [
          `
다름이 아니라, 교수님께서 이번 /*0000-0학기*/ 진행하시는 SUBJECT 과목을 듣고자 수강신청을 시도했으나 안타깝게도 정원에 들지못하였습니다. 이에 대해 혹시 수강 인원 증원이 가능한지 문의하고자 메일을 드립니다. 
/*
(만약 해당 수업을 들어야 하는 이유가 있다면) 예시: 저는 ~한 이유로 이번학기 교수님의 00과목 수업을 수강하여 00하고자 합니다. 수강 인원 증원을 꼭 한번 고려해주시면 정말 감사드리겠습니다.
*/
`,
        ],
      },
